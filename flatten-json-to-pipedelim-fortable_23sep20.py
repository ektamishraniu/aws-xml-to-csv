...
def createROtabs(alltabsInfo, typexml, mytab, srcFile="undefinedFile.json"):    
    ...
    if(typexml == "invoice"):
        ...
        if(mytab == "ro_invoice"):
            ...
            roTab["invoice_tot_amt"] = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcessedBy.EventContact.ContactName.FirstName", None, maxNN)
            roTab["invoice_tax_tot_amt"]  = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcessedBy.EventContact.ContactName.LastName", None, maxNN)
            roTab["processed_ts"]     = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.LastModifiedDateTime", None, maxNN)
            roTab["processed_by_first_nm"] = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcessedBy.EventContact.ContactName.FirstName", None, maxNN)
            roTab["processed_by_last_nm"]  = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcessedBy.EventContact.ContactName.LastName", None, maxNN)
            roTab["src_created_ts"]   = getValsFromDict(DocumentInfo, "CreateDateTime", None, maxNN)
        ...
        if(mytab == "ro_invoice_detail"):
            ...
            roTab["repair_order_num"] = getValsFromDict(RepairOrderHeader, "RepairOrderIDs.RepairOrderNum", None, maxNN)
            roTab["po_ref_num"]       = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementRefInfo.RefNum", None, maxNN)
            roTab["po_ref_line_num"]  = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.ProcurementRefLineNum", None, maxNN)
            roTab["supplier_ref_line_num"]= getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.SupplierRefLineNum", None, maxNN)
            roTab["supplier_response_cd"] = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.SupplierResponseCode", None, maxNN)
            roTab["part_num"]         = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.PartNumInfo.1.PartNum", None, maxNN)
            roTab["part_typ"]         = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.PartType", None, maxNN)
            roTab["part_desc"]        = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.PartDesc", None, maxNN)
            roTab["fulfilled_qty"]         = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.FulfilledInfo.Quantity", None, maxNN)
            roTab["part_unit_list_price"]= getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.PriceInfo.UnitListPrice", None, maxNN)
            roTab["part_unit_net_price"] = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.InvoiceInfo.InvoiceItemList.InvoiceItem.NNV0.PriceInfo.UnitNetPrice", None, maxNN)
            roTab["request_hold_ind"] = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.RequestHoldInd", None, maxNN)
            roTab["src_created_ts"]   = getValsFromDict(DocumentInfo, "CreateDateTime", None, maxNN)
            roTab["dw_created_ts"]    = getValsFromDict(RepairOrderHeader, "",          timestamp, maxNN)
            roTab["dw_created_by"]    = getValsFromDict(RepairOrderHeader, "",               acid, maxNN)
    ...
    if(typexml == "purchase_order"):
        ...
        if(mytab == "ro_purchase_order_detail"):
            ...
            roTab["repair_order_num"] = getValsFromDict(RepairOrderHeader, "RepairOrderIDs.RepairOrderNum", None, maxNN)
            roTab["po_ref_num"]       = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementRefInfo.RefNum", None, maxNN)
            roTab["po_ref_line_num"]  = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.ProcurementPart.NNV0.ProcurementRefLineNum", None, maxNN)
            roTab["po_unique_seq_num"]= getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.ProcurementPart.NNV0.SelectedPart.UniqueSequenceNum", None, maxNN)
            roTab["part_num"]         = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.ProcurementPart.NNV0.SelectedPart.PartNumInfo.PartNum", None, maxNN)
            roTab["part_typ"]         = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.ProcurementPart.NNV0.SelectedPart.PartType", None, maxNN)
            roTab["part_desc"]        = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.ProcurementPart.NNV0.SelectedPart.PartDesc", None, maxNN)
            roTab["part_qty"]         = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.ProcurementPart.NNV0.SelectedPart.Quantity", None, maxNN)
            roTab["part_unit_list_price"]= getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.ProcurementPart.NNV0.SelectedPart.PriceInfo.UnitListPrice", None, maxNN)
            roTab["part_unit_net_price"] = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.ProcurementPart.NNV0.SelectedPart.PriceInfo.UnitNetPrice", None, maxNN)
            roTab["request_hold_ind"] = getValsFromDict(SupplierInvoices, "SupplierInvoice.ProcurementFolder.ProcurementInfo.ProcurementPartList.RequestHoldInd", None, maxNN)
            roTab["src_created_ts"]   = getValsFromDict(DocumentInfo, "CreateDateTime", None, maxNN)
            roTab["dw_created_ts"]    = getValsFromDict(RepairOrderHeader, "",          timestamp, maxNN)
            roTab["dw_created_by"]    = getValsFromDict(RepairOrderHeader, "",               acid, maxNN)
...
def lambda_handler(event, context):
    ...
    typexmlDict["opportunity"]     = ["Opportunity_Create", "Opportunity_Update"]
    typexmlDict["purchase_order"]  = ["PurchaseOrder_Create", "PurchaseOrder_Update"]
    typexmlDict["invoice"]         = ["Invoice_Create", "Invoice_Update"]
    typexmlDict["credit_memo"]     = ["CreditMemo_Acknowledge", "CreditMemo_Update"]
    ...
    if not typexml: 
        return {
        'statusCode': 200,
        'body': json.dumps("No TypeXML detected for EventTopic: "+EventTopic)
    }
    ...
    if typexml == "opportunity":
        table_list = ["opportunity", "opp_note", "opp_damage_line", "opp_rate_info", "opp_total_info", "opp_event"]    
    if(typexml == "purchase_order"):
