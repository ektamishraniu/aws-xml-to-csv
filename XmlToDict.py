...
def parseXmlToJson(xmlfilename):
    ...
    alltabsInfo["EventTopic"] = getValueForTab()

    print(alltabsInfo["RepairOrderHeader"]["RepairOrderIDs.RepairOrderNum"])
    print(alltabsInfo["DocumentInfo"]["CreateDateTime"])
    #for key, value in alltabsInfo["RepairOrderHeader"].items():
    #    print(key, value)
