...
-- ******************************************************************
-- ************************************** repair_order
drop table public.repair_order_final cascade;
CREATE TABLE public.repair_order_final
(
 ...
 CONSTRAINT PK_repair_order_final PRIMARY KEY ( repair_order_num )
);
...
-- ******************************************************************
-- ************************************** ro_damage_line
drop table public.ro_damage_line_final cascade;
CREATE TABLE ro_damage_line_final
(
 repair_order_num              varchar(50) NOT NULL,
 line_num                      varchar(50),
 ...
 dw_modified_ts                timestamp,
 dw_modified_by                varchar(50),
 CONSTRAINT FK_166f FOREIGN KEY ( repair_order_num ) REFERENCES repair_order ( repair_order_num )
);
...
(
 ...
 dw_modified_ts    timestamp,
 dw_modified_by    varchar(50),
 CONSTRAINT FK_156f FOREIGN KEY ( repair_order_num ) REFERENCES repair_order ( repair_order_num )
);
...
-- ******************************************************************
-- ************************************** ro_note
drop table public.ro_note;
CREATE TABLE ro_note_final
(
 repair_order_num     varchar(50) NOT NULL,
 ...
 dw_modified_ts       timestamp,
 dw_modified_by       varchar(50),
 CONSTRAINT FK_159f FOREIGN KEY ( repair_order_num ) REFERENCES repair_order ( repair_order_num )
);
...
-- ******************************************************************
-- ************************************** ro_rate_info
drop table public.ro_rate_info cascade;
CREATE TABLE ro_rate_info_final
(
 repair_order_num    varchar(50) NOT NULL,
 rate_typ            varchar(50),
 ...
 dw_modified_ts      timestamp,
 dw_modified_by      varchar(50),
 CONSTRAINT FK_153f FOREIGN KEY ( repair_order_num ) REFERENCES repair_order ( repair_order_num )
);
...
-- ******************************************************************
-- ************************************** ro_total_info
drop table public.ro_total_info cascade;
CREATE TABLE ro_total_info_final
(
 repair_order_num  varchar(50) NOT NULL,
 ...
 dw_modified_ts  timestamp,
 dw_modified_by  varchar(50),
 CONSTRAINT FK_163f FOREIGN KEY ( repair_order_num ) REFERENCES repair_order ( repair_order_num )
);