-- Redshift External repair_order
create external table spectrum.repair_order(
...
stored as textfile
location 's3://pipedelimfiles-for-table/repair_order/'
table properties ('skip.header.line.count'='1');


-- Redshift External ro_damage_line
create external table spectrum.ro_damage_line(
 repair_order_num              varchar(50),
 line_num                      varchar(50),
...
fields terminated by '|'
stored as textfile
location 's3://pipedelimfiles-for-table/ro_damage_line/'
table properties ('skip.header.line.count'='1'); 
 


-- Redshift External ro_event
create external table spectrum.ro_event(
 repair_order_num  varchar(50),
...
fields terminated by '|'
stored as textfile
location 's3://pipedelimfiles-for-table/ro_event/'
table properties ('skip.header.line.count'='1'); 


-- Redshift External ro_note
create external table spectrum.ro_note(
 repair_order_num     varchar(50),
...
fields terminated by '|'
stored as textfile
location 's3://pipedelimfiles-for-table/ro_note/'
table properties ('skip.header.line.count'='1'); 


-- Redshift External ro_rate_info
create external table spectrum.ro_rate_info(
 repair_order_num    varchar(50),
 rate_typ            varchar(50),
...
fields terminated by '|'
stored as textfile
location 's3://pipedelimfiles-for-table/ro_rate_info/'
table properties ('skip.header.line.count'='1'); 


-- Redshift External ro_total_info
create external table spectrum.ro_total_info(
 repair_order_num  varchar(50),
...
fields terminated by '|'
stored as textfile
location 's3://pipedelimfiles-for-table/ro_total_info/'
table properties ('skip.header.line.count'='1'); 


create external table spectrum.log_table(
 repair_order_num  varchar(50),
 src_created_ts    timestamp,  
